...
static const QStringList EX_DEFEAT_SCRIPT = {
    QStringLiteral("旧日执念：我居然会输给你，真的很不甘心。"),
    QStringLiteral("但我遵守约定，为你解锁前路。"),
    QStringLiteral("你要找的那个人，就在幻境的上一层。"),
    QStringLiteral("我已经很久没有见过他了。"),
    QStringLiteral("曾经的他满眼皆是温柔，那般热烈地爱着我。"),
    QStringLiteral("可后来，他再也没有来找过我。"),
    QStringLiteral("哼，原来所有的偏爱，都只是一时的谎言。"),
    QStringLiteral("去吧，YAN，帮我了结这段虚妄的执念，消灭那个负心的渣男。"),
};
...
void Chapter3_Rebellion::onEnter()
{
    ...
    m_scene->setBackgroundImage(":/images/ch03/YAN_Fight_XIA.png");
...
void Chapter3_Rebellion::update()
{
    ...
    case SUFA_FIGHT:
        ...
        if (m_boss && m_boss->isDead()) {
            ...
            m_scene->setBackgroundImage(":/images/ch03/XIA_Die1.png");
            m_combat->endCombat();
...
{
    switch (m_phase) {
    case NEWYORK:    return { QStringLiteral("城市篇章 · 纽约"), QStringLiteral("向右前行，奔赴山海"), QColor(60, 60, 80) };
    case SHANGHAI:   return { QStringLiteral("城市篇章 · 上海"), QStringLiteral("旧日回忆涌现，前往上海政法学院"), QColor(40, 50, 70) };
    case SUFA_FIGHT: case SUFA_DEFEAT_DLG:
                     return { QStringLiteral("城市篇章 · 上海政法学院【执念之战】"), QString(), QColor(50, 45, 65) };
    }
    return {};
}
