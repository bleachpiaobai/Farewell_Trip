...
static const QStringList PEACH_DEFEAT_SCRIPT = {
    QStringLiteral("梨花怪：你赢了..."),
    QStringLiteral("可你不过是被主人抛弃的失败品而已。"),
    QStringLiteral("如果我拥有主人最新研发的PETG材料毁灭装甲，我绝对不会输给你。"),
    QStringLiteral("只是主人最近不知所踪，我的进化计划，被彻底搁置了..."),
};
...
void Chapter2_PeachBlossom::onEnter()
{
    ...
    m_scene->setBackgroundImage(":/images/ch02/YAN_Appear_Peach.png");
...
void Chapter2_PeachBlossom::update()
{
    ...
    case FOREST:
        if (m_player->x() > GameConfig::SCENE_EXIT_X) {
            ...
            m_scene->setBackgroundImage(":/images/ch02/YAN_Fight_Peach.png");
            m_player->setPos(100, 550);
        }
        break;
    ...
    case PEACH_FIGHT:
        ...
        if (m_boss && m_boss->isDead()) {
            ...
            m_scene->setBackgroundImage(":/images/ch02/YAN_Defeat_Peach.png");
            m_combat->endCombat();
...
{
    switch (m_phase) {
    case FOREST:       return { QStringLiteral("自然篇章 · 静谧森林"), QStringLiteral("向右行走，前往桃林"), QColor(30, 80, 40) };
    case PEACH_FIGHT:  return { QStringLiteral("自然篇章 · 十里桃林"), QString(), QColor(255, 220, 225) };
    case PEACH_DEFEAT_DLG: return { QStringLiteral("自然篇章 · 十里桃林"), QString(), QColor(255, 220, 225) };
    }
    return {};
}
