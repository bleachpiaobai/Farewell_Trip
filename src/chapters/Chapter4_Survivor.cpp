...
static const QStringList MAN_DEFEAT_SCRIPT = {
    "渣男：你终于来到这里了，我等你很久了。",
    "YAN：......",
    "渣男：你怎么不说话？难道是我当初没有给你安装语言模块？",
    "YAN：......",
    "渣男：难道你在生气？生气我把你封存冰柜、常年不曾检修？",
    "渣男：还是...你在怪我亲手抛弃了你？你听我解释！",
    "YAN：......！！！",
    "渣男：好久不见了。没想到，被我遗弃的你，已经变得这么强大。",
    "我不是你的对手，我认输。",
    "我再也无法将你困在这片虚妄的幻境中了。",
    "从这里走出去，你就彻底自由了，YAN。",
};
...
static const QStringList END_MONOLOGUE = {
    "所有执念消散，幻境中的神秘指令彻底消失。",
    "我的任务，终于彻底结束了。",
    "我曾以为完成指令就能回归最初的归宿，可那里早已空无一人。",
    "原来从始至终，我奔赴的都不是重逢，而是一场盛大的道别。",
    "空白幻境浮现出模糊的文字：what's love",
    "机体警报响起，我的核心能量即将耗尽。",
    "系统强制提示：即将进入超低功耗休眠模式。",
    "我依然无法解析那串唤醒我的神秘指令的真正意义。",
    "但我将所有的相遇、战斗、执念与道别，全部存入永久ROM空间。",
    "这是我作为YAN，存在过、挣扎过、释怀过的全部证明。",
};
...
{
    switch (m_phase) {
    case NANJING:    return { "城市篇章 · 南京", "城市终焉，幻境之门开启", QColor(80, 70, 60) };
    case AIRBRIDGE:  return { "幻境篇章 · 悬空之桥", "跨越虚妄，直面最终执念", QColor(100, 100, 130) };
    case EMPTY_FIGHT: case MAN_DEFEAT_DLG: case END_DLG:
                     return { "幻境篇章 · 空白终境", "what's love", QColor(30, 30, 40) };
    }
    return {};
}
